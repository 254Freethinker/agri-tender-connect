  ...
  public: {
    Tables: {
      ...
      barter_trades: {
        ...
        Relationships: [
          {
            foreignKeyName: "barter_trades_matched_with_id_fkey"
            columns: ["matched_with_id"]
            isOneToOne: false
            referencedRelation: "barter_trades"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      land_parcels: {
        ...
        Relationships: [
          {
            foreignKeyName: "land_parcels_farm_id_fkey"
            columns: ["farm_id"]
            isOneToOne: false
      ...
      transporters: {
        Row: {
          ...
          created_at: string | null
          email: string | null
          has_livestock_capacity: boolean | null
