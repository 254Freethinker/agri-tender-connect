    ...
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-16">
        <div 
          ...
          style={{ backgroundImage: `url(${communityHeroBg})` }}
        >
          <div className="absolute inset-0 bg-gradient-to-br from-primary/85 via-primary/70 to-primary/50" />
        </div>
        <div className="relative container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 drop-shadow-lg">Community Forum</h1>
          <p className="text-white/90 text-lg drop-shadow">Connect with fellow farmers and agricultural experts</p>
        </div>
      </section>
