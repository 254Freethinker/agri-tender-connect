...
import { LivestockMarket, LivestockType, LivestockForSale, AnimalGender } from '@/types/livestock';
...
export const LivestockMarketplace: React.FC = () => {
